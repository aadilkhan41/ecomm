...
const ProductView: React.FC<ProductViewProps> = ({ 
  ...
  // Generate an array of images (repeating the main image for the gallery simulation)
          ...
          <div className="grid grid-cols-4 gap-4">
            {images.map((img, idx) => (
              <button 
                ...
                className={`bg-[#F9F9F9] rounded-xl p-2 aspect-square flex items-center justify-center border-2 transition-all ${selectedImage === idx ? 'border-primary' : 'border-transparent hover:border-gray-200'}`}
              >
